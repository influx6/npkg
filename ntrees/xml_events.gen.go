// Code auto-generated to provide HTML and SVG DOM Nodes.
...
func AbortEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("abort", handler, mods...)
}


// AfterPrintEvent provides DOM Event representation for the Event "AfterPrint".
// 
// The associated document has started printing or the print preview has been
// closed.
// https://developer.mozilla.org/docs/Web/Events/afterprint
func AfterPrintEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("AfterPrint", handler, mods...)
}
...
// 
// A notification element is shown.
// https://developer.mozilla.org/docs/Web/Reference/Events/AlertActive
func AlertActiveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("AlertActive", handler, mods...)
}


// AlertCloseEvent provides DOM Event representation for the Event "AlertClose".
// 
// A notification element is closed.
// https://developer.mozilla.org/docs/Web/Reference/Events/AlertClose
func AlertCloseEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("AlertClose", handler, mods...)
}
...
func AlertingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("alerting", handler, mods...)
}
...
func AnimationEndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("AnimationEnd", handler, mods...)
}
...
func AnimationIterationEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("AnimationIteration", handler, mods...)
}
...
func AnimationStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("AnimationStart", handler, mods...)
}
...
func ApplicationInstalledEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ApplicationInstalled", handler, mods...)
}
...
func AudioEndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("AudioEnd", handler, mods...)
}
...
func AudioProcessEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("AudioProcess", handler, mods...)
}
...
func AudioStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("AudioStart", handler, mods...)
}
...
func AuxclickEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("auxclick", handler, mods...)
}
...
func BeforePrintEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("BeforePrint", handler, mods...)
}
...
func BeforeUnloadEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("BeforeUnload", handler, mods...)
}
...
func BeforeinstallpromptEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("beforeinstallprompt", handler, mods...)
}
...
func BeforescriptexecuteEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("beforescriptexecute", handler, mods...)
}
...
func BeginEventEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("beginEvent", handler, mods...)
}
...
func BlockedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("blocked", handler, mods...)
}
...
func BlurEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("blur", handler, mods...)
}
...
func BoundaryEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("boundary", handler, mods...)
}
...
func BroadcastEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("broadcast", handler, mods...)
}
...
func BusyEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("busy", handler, mods...)
}


// CSSRuleViewCSSLinkClickedEvent provides DOM Event representation for the Event "CSSRuleViewCSSLinkClicked".
// 
// A link to a CSS file has been clicked in the "Rules" view of the style
// inspector.
// https://developer.mozilla.org/docs/Web/Reference/Events/CssRuleViewCSSLinkClicked
func CSSRuleViewCSSLinkClickedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("CSSRuleViewCSSLinkClicked", handler, mods...)
}
...
func CSSRuleViewChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("CSSRuleViewChange", handler, mods...)
}
...
func CSSRuleViewRefreshedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("CSSRuleViewRefreshed", handler, mods...)
}
...
func CachedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("cached", handler, mods...)
}
...
func CallschangedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("callschanged", handler, mods...)
}


// CanPlayEvent provides DOM Event representation for the Event "CanPlay".
// 
// The user agent can play the media, but estimates that not enough data has
...
func CanPlayEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("CanPlay", handler, mods...)
}


// CanPlayThroughEvent provides DOM Event representation for the Event "CanPlayThrough".
// 
// The user agent can play the media up to its end without having to stop for
// further buffering of content.
// https://developer.mozilla.org/docs/Web/Events/canplaythrough
func CanPlayThroughEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("CanPlayThrough", handler, mods...)
}
...
func CardstatechangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("cardstatechange", handler, mods...)
}
...
func CfstatechangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("cfstatechange", handler, mods...)
}


// ChangeEvent provides DOM Event representation for the Event "change".
// 
// This event is triggered each time a file is created, modified or deleted on
// a given storage area.
// https://developer.mozilla.org/docs/Web/Events/change
func ChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("change", handler, mods...)
}
...
func ChargingChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ChargingChange", handler, mods...)
}
...
func ChargingTimeChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ChargingTimeChange", handler, mods...)
}


// CheckboxStateChangeEvent provides DOM Event representation for the Event "CheckboxStateChange".
// 
// The state of a checkbox has been changed either by a user action or by a
// script (useful for accessibility).
// https://developer.mozilla.org/docs/Web/Events/CheckboxStateChange
func CheckboxStateChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("CheckboxStateChange", handler, mods...)
}
...
// cache manifest for the first time.
// https://developer.mozilla.org/docs/Web/Events/checking
func CheckingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("checking", handler, mods...)
}
...
func ClickEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("click", handler, mods...)
}
...
func CloseEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("close", handler, mods...)
}
...
func CommandEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("command", handler, mods...)
}
...
func CommandupdateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("commandupdate", handler, mods...)
}
...
func CompleteEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("complete", handler, mods...)
}
...
func CompositionEndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("CompositionEnd", handler, mods...)
}


// CompositionStartEvent provides DOM Event representation for the Event "CompositionStart".
// 
// The composition of a passage of text is prepared (similar to keydown for a
...
func CompositionStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("CompositionStart", handler, mods...)
}
...
func CompositionUpdateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("CompositionUpdate", handler, mods...)
}
...
func ConnectingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("connecting", handler, mods...)
}
...
func ConnectionInfoUpdateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("connectionInfoUpdate", handler, mods...)
}
...
func ContextMenuEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ContextMenu", handler, mods...)
}
...
func CopyEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("copy", handler, mods...)
}


// CutEvent provides DOM Event representation for the Event "cut".
// 
// The text selection has been removed from the document and added to the
// clipboard.
// https://developer.mozilla.org/docs/Web/Events/cut
func CutEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("cut", handler, mods...)
}
...
func DOMAutoCompleteEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMAutoComplete", handler, mods...)
}
...
func DOMContentLoadedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMContentLoaded", handler, mods...)
}
...
func DOMFrameContentLoadedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMFrameContentLoaded", handler, mods...)
}
...
func DOMLinkAddedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMLinkAdded", handler, mods...)
}
...
func DOMLinkRemovedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMLinkRemoved", handler, mods...)
}
...
func DOMMenuItemActiveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMMenuItemActive", handler, mods...)
}
...
func DOMMenuItemInactiveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMMenuItemInactive", handler, mods...)
}
...
func DOMMetaAddedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMMetaAdded", handler, mods...)
}
...
func DOMMetaRemovedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMMetaRemoved", handler, mods...)
}
...
func DOMModalDialogClosedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMModalDialogClosed", handler, mods...)
}
...
func DOMPopupBlockedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMPopupBlocked", handler, mods...)
}
...
func DOMTitleChangedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMTitleChanged", handler, mods...)
}
...
func DOMWillOpenModalDialogEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMWillOpenModalDialog", handler, mods...)
}
...
func DOMWindowCloseEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMWindowClose", handler, mods...)
}
...
func DOMWindowCreatedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DOMWindowCreated", handler, mods...)
}
...
func DatachangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("datachange", handler, mods...)
}
...
func DataerrorEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("dataerror", handler, mods...)
}
...
func DeliveredEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("delivered", handler, mods...)
}


// DeviceChangeEvent provides DOM Event representation for the Event "DeviceChange".
// 
// A media device such as a camera, microphone, or speaker is connected or
// removed from the system.
// https://developer.mozilla.org/docs/Web/Events/devicechange
func DeviceChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DeviceChange", handler, mods...)
}
...
func DeviceLightEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DeviceLight", handler, mods...)
}
...
func DeviceMotionEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DeviceMotion", handler, mods...)
}
...
func DeviceOrientationEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DeviceOrientation", handler, mods...)
}


// DeviceProximityEvent provides DOM Event representation for the Event "DeviceProximity".
// 
// Fresh data is available from a proximity sensor (indicates an approximated
// distance between the device and a nearby object).
// https://developer.mozilla.org/docs/Web/Events/deviceproximity
func DeviceProximityEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DeviceProximity", handler, mods...)
}
...
func DialingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("dialing", handler, mods...)
}
...
func DisabledEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("disabled", handler, mods...)
}
...
func DischargingTimeChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DischargingTimeChange", handler, mods...)
}
...
func DisconnectedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("disconnected", handler, mods...)
}
...
func DisconnectingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("disconnecting", handler, mods...)
}
...
func DoubleClickEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DoubleClick", handler, mods...)
}
...
// resources listed by the cache manifest for the first time.
// https://developer.mozilla.org/docs/Web/Events/downloading
func DownloadingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("downloading", handler, mods...)
}
...
func DragEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("drag", handler, mods...)
}


// DragEndEvent provides DOM Event representation for the Event "DragEnd".
// 
// A drag operation is being ended (by releasing a mouse button or hitting the
// escape key).
// https://developer.mozilla.org/docs/Web/Events/dragend
func DragEndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DragEnd", handler, mods...)
}
...
func DragEnterEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DragEnter", handler, mods...)
}
...
func DragLeaveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DragLeave", handler, mods...)
}
...
func DragOverEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DragOver", handler, mods...)
}
...
func DragStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DragStart", handler, mods...)
}
...
func DropEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("drop", handler, mods...)
}
...
func DurationChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("DurationChange", handler, mods...)
}
...
func EmptiedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("emptied", handler, mods...)
}
...
func EnabledEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("enabled", handler, mods...)
}
...
func EndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("end", handler, mods...)
}
...
func EndEventEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("endEvent", handler, mods...)
}
...
func EndedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ended", handler, mods...)
}
...
func FocusEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("focus", handler, mods...)
}
...
func FocusInEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("FocusIn", handler, mods...)
}
...
func FocusOutEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("FocusOut", handler, mods...)
}
...
func FullScreenChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("FullScreenChange", handler, mods...)
}


// FullScreenErrorEvent provides DOM Event representation for the Event "FullScreenError".
// 
// It was impossible to switch to fullscreen mode for technical reasons or
// because the permission was denied.
// https://developer.mozilla.org/docs/Web/Events/fullscreenerror
func FullScreenErrorEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("FullScreenError", handler, mods...)
}
...
func FullscreenEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("fullscreen", handler, mods...)
}
...
func GamepadConnectedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("GamepadConnected", handler, mods...)
}
...
func GamepadDisconnectedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("GamepadDisconnected", handler, mods...)
}
...
func GotPointerCaptureEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("GotPointerCapture", handler, mods...)
}


// HashChangeEvent provides DOM Event representation for the Event "HashChange".
// 
// The fragment identifier of the URL has changed (the part of the URL after
// the #).
// https://developer.mozilla.org/docs/Web/Events/hashchange
func HashChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("HashChange", handler, mods...)
}
...
func HeldEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("held", handler, mods...)
}
...
func HoldingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("holding", handler, mods...)
}


// ICCCardLockErrorEvent provides DOM Event representation for the Event "ICCCardLockError".
// 
// the MozMobileConnection.unlockCardLock() or
// MozMobileConnection.setCardLock() methods fails.
// https://developer.mozilla.org/docs/Web/Events/icccardlockerror
func ICCCardLockErrorEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ICCCardLockError", handler, mods...)
}
...
func IccinfochangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("iccinfochange", handler, mods...)
}
...
func IncomingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("incoming", handler, mods...)
}
...
func InputEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("input", handler, mods...)
}
...
func InvalidEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("invalid", handler, mods...)
}
...
func KeyDownEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("KeyDown", handler, mods...)
}
...
func KeyPressEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("KeyPress", handler, mods...)
}
...
func KeyUpEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("KeyUp", handler, mods...)
}
...
func LanguageChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("LanguageChange", handler, mods...)
}
...
func LevelChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("LevelChange", handler, mods...)
}
...
func LoadEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("load", handler, mods...)
}


// LoadEndEvent provides DOM Event representation for the Event "LoadEnd".
// 
// Progress has stopped (after "error", "abort" or "load" have been
// dispatched).
// https://developer.mozilla.org/docs/Web/Events/loadend
func LoadEndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("LoadEnd", handler, mods...)
}
...
func LoadStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("LoadStart", handler, mods...)
}
...
func LoadedDataEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("LoadedData", handler, mods...)
}
...
func LoadedMetadataEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("LoadedMetadata", handler, mods...)
}
...
func LocalizedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("localized", handler, mods...)
}
...
func LostPointerCaptureEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("LostPointerCapture", handler, mods...)
}
...
// 
// (no documentation)
// https://developer.mozilla.org/docs/Web/Events/MSManipulationStateChanged
func MSManipulationStateChangedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MSManipulationStateChanged", handler, mods...)
}
...
func MarkEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mark", handler, mods...)
}


// MessageEvent provides DOM Event representation for the Event "message".
// 
// A message is received from a service worker, or a message is received in a
// service worker from another context.
// https://developer.mozilla.org/docs/Web/Events/message_(ServiceWorker)
func MessageEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("message", handler, mods...)
}
...
func MessageErrorEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MessageError", handler, mods...)
}
...
func MouseDownEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MouseDown", handler, mods...)
}
...
func MouseEnterEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MouseEnter", handler, mods...)
}
...
func MouseLeaveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MouseLeave", handler, mods...)
}
...
func MouseMoveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MouseMove", handler, mods...)
}


// MouseOutEvent provides DOM Event representation for the Event "MouseOut".
// 
// A pointing device is moved off the element that has the listener attached or
// off one of its children.
// https://developer.mozilla.org/docs/Web/Events/mouseout
func MouseOutEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MouseOut", handler, mods...)
}
...
func MouseOverEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MouseOver", handler, mods...)
}
...
func MouseUpEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MouseUp", handler, mods...)
}
...
func MozAfterPaintEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozAfterPaint", handler, mods...)
}
...
func MozAudioAvailableEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozAudioAvailable", handler, mods...)
}
...
func MozBeforeResizeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozBeforeResize", handler, mods...)
}


// MozEdgeUIGestureEvent provides DOM Event representation for the Event "MozEdgeUIGesture".
// 
// A touch point is swiped across the touch surface to invoke the edge UI (Win8
// only).
// https://developer.mozilla.org/docs/Web/Reference/Events/MozEdgeUIGesture
func MozEdgeUIGestureEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozEdgeUIGesture", handler, mods...)
}
...
func MozEnteredDomFullscreenEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozEnteredDomFullscreen", handler, mods...)
}
...
func MozGamepadButtonDownEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozGamepadButtonDown", handler, mods...)
}
...
func MozGamepadButtonUpEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozGamepadButtonUp", handler, mods...)
}


// MozMagnifyGestureEvent provides DOM Event representation for the Event "MozMagnifyGesture".
// 
// Two touch points moved away from each other (after a sequence of
// MozMagnifyGestureUpdate).
// https://developer.mozilla.org/docs/Web/Reference/Events/MozMagnifyGesture
func MozMagnifyGestureEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozMagnifyGesture", handler, mods...)
}
...
func MozMagnifyGestureStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozMagnifyGestureStart", handler, mods...)
}
...
func MozMagnifyGestureUpdateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozMagnifyGestureUpdate", handler, mods...)
}
...
// second finger down, second finger up, first finger up).
// https://developer.mozilla.org/docs/Web/Reference/Events/MozPressTapGesture
func MozPressTapGestureEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozPressTapGesture", handler, mods...)
}


// MozRotateGestureEvent provides DOM Event representation for the Event "MozRotateGesture".
// 
// Two touch points rotate around a point (after a sequence of
// MozRotateGestureUpdate).
// https://developer.mozilla.org/docs/Web/Reference/Events/MozRotateGesture
func MozRotateGestureEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozRotateGesture", handler, mods...)
}
...
func MozRotateGestureStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozRotateGestureStart", handler, mods...)
}
...
func MozRotateGestureUpdateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozRotateGestureUpdate", handler, mods...)
}
...
func MozScrolledAreaChangedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozScrolledAreaChanged", handler, mods...)
}
...
func MozSwipeGestureEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozSwipeGesture", handler, mods...)
}
...
func MozTapGestureEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("MozTapGesture", handler, mods...)
}
...
func MozbrowseractivitydoneEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowseractivitydone", handler, mods...)
}
...
func MozbrowserasyncscrollEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserasyncscroll", handler, mods...)
}
...
func MozbrowseraudioplaybackchangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowseraudioplaybackchange", handler, mods...)
}
...
func MozbrowsercaretstatechangedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowsercaretstatechanged", handler, mods...)
}
...
func MozbrowsercloseEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserclose", handler, mods...)
}
...
func MozbrowsercontextmenuEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowsercontextmenu", handler, mods...)
}
...
func MozbrowserdocumentfirstpaintEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserdocumentfirstpaint", handler, mods...)
}


// MozbrowsererrorEvent provides DOM Event representation for the Event "mozbrowsererror".
// 
// Sent when an error occured while trying to load a content within a browser
// iframe
// https://developer.mozilla.org/docs/Web/Events/mozbrowsererror
func MozbrowsererrorEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowsererror", handler, mods...)
}


// MozbrowserfindchangeEvent provides DOM Event representation for the Event "mozbrowserfindchange".
// 
// Sent when a search operation is performed on the browser <iframe> content
// (see HTMLIFrameElement search methods.)
// https://developer.mozilla.org/docs/Web/Events/mozbrowserfindchange
func MozbrowserfindchangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserfindchange", handler, mods...)
}


// MozbrowserfirstpaintEvent provides DOM Event representation for the Event "mozbrowserfirstpaint".
// 
// Sent when the <iframe> paints content for the first time (this doesn't
// include the initial paint from about:blank.)
// https://developer.mozilla.org/docs/Web/Events/mozbrowserfirstpaint
func MozbrowserfirstpaintEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserfirstpaint", handler, mods...)
}
...
func MozbrowsericonchangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowsericonchange", handler, mods...)
}
...
func MozbrowserloadendEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserloadend", handler, mods...)
}
...
func MozbrowserloadstartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserloadstart", handler, mods...)
}
...
func MozbrowserlocationchangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserlocationchange", handler, mods...)
}
...
// <iframe> with an open web app embedded in it.
// https://developer.mozilla.org/docs/Web/Events/mozbrowsermanifestchange
func MozbrowsermanifestchangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowsermanifestchange", handler, mods...)
}


// MozbrowsermetachangeEvent provides DOM Event representation for the Event "mozbrowsermetachange".
// 
// Sent when a <meta> elelment is added to, removed from or changed in the
// browser <iframe>'s content.
// https://developer.mozilla.org/docs/Web/Events/mozbrowsermetachange
func MozbrowsermetachangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowsermetachange", handler, mods...)
}
...
func MozbrowseropensearchEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowseropensearch", handler, mods...)
}


// MozbrowseropentabEvent provides DOM Event representation for the Event "mozbrowseropentab".
// 
// Sent when a new tab is opened within a browser <iframe> as a result of the
// user issuing a command to open a link target in a new tab (for example
// ctrl/cmd + click.)
// https://developer.mozilla.org/docs/Web/Events/mozbrowseropentab
func MozbrowseropentabEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowseropentab", handler, mods...)
}
...
func MozbrowseropenwindowEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowseropenwindow", handler, mods...)
}
...
func MozbrowserresizeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserresize", handler, mods...)
}
...
func MozbrowserscrollEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserscroll", handler, mods...)
}
...
// can occur on resize and when the page size changes (while loading for
// example.)
// https://developer.mozilla.org/docs/Web/Events/mozbrowserscrollareachanged
func MozbrowserscrollareachangedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserscrollareachanged", handler, mods...)
}
...
func MozbrowserscrollviewchangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserscrollviewchange", handler, mods...)
}
...
func MozbrowsersecuritychangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowsersecuritychange", handler, mods...)
}
...
func MozbrowserselectionstatechangedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserselectionstatechanged", handler, mods...)
}
...
func MozbrowsershowmodalpromptEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowsershowmodalprompt", handler, mods...)
}
...
func MozbrowsertitlechangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowsertitlechange", handler, mods...)
}
...
func MozbrowserusernameandpasswordrequiredEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowserusernameandpasswordrequired", handler, mods...)
}
...
func MozbrowservisibilitychangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("mozbrowservisibilitychange", handler, mods...)
}
...
func MoztimechangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("moztimechange", handler, mods...)
}
...
// 
// (no documentation)
// https://developer.mozilla.org/docs/Web/Events/msContentZoom
func MsContentZoomEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("msContentZoom", handler, mods...)
}


// NoMatchEvent provides DOM Event representation for the Event "NoMatch".
// 
// The speech recognition service returns a final result with no significant
// recognition.
// https://developer.mozilla.org/docs/Web/Events/nomatch
func NoMatchEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("NoMatch", handler, mods...)
}
...
func NoUpdateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("NoUpdate", handler, mods...)
}
...
func NotificationClickEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("NotificationClick", handler, mods...)
}
...
func ObsoleteEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("obsolete", handler, mods...)
}
...
func OfflineEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("offline", handler, mods...)
}
...
func OnconnectedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("onconnected", handler, mods...)
}


// OnlineEvent provides DOM Event representation for the Event "online".
// 
// The browser has gained access to the network (but particular websites might
// be unreachable).
// https://developer.mozilla.org/docs/Web/Events/online
func OnlineEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("online", handler, mods...)
}
...
func OpenEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("open", handler, mods...)
}
...
func OrientationChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("OrientationChange", handler, mods...)
}


// OverflowEvent provides DOM Event representation for the Event "overflow".
// 
// An element has been overflowed by its content or has been rendered for the
// first time in this state (only works for elements styled with overflow !=
// visible).
// https://developer.mozilla.org/docs/Web/Events/overflow
func OverflowEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("overflow", handler, mods...)
}
...
func PageHideEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PageHide", handler, mods...)
}
...
func PageShowEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PageShow", handler, mods...)
}
...
func PasteEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("paste", handler, mods...)
}
...
func PauseEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("pause", handler, mods...)
}
...
func PlayEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("play", handler, mods...)
}
...
func PlayingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("playing", handler, mods...)
}
...
func PointerCancelEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerCancel", handler, mods...)
}
...
func PointerDownEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerDown", handler, mods...)
}
...
func PointerEnterEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerEnter", handler, mods...)
}
...
func PointerLeaveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerLeave", handler, mods...)
}
...
func PointerLockChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerLockChange", handler, mods...)
}


// PointerLockErrorEvent provides DOM Event representation for the Event "PointerLockError".
// 
// It was impossible to lock the pointer for technical reasons or because the
// permission was denied.
// https://developer.mozilla.org/docs/Web/Events/pointerlockerror
func PointerLockErrorEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerLockError", handler, mods...)
}
...
func PointerMoveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerMove", handler, mods...)
}


// PointerOutEvent provides DOM Event representation for the Event "PointerOut".
// 
// The pointing device moved out of hit-testing boundary or leaves detectable
// hover range.
// https://developer.mozilla.org/docs/Web/Events/pointerout
func PointerOutEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerOut", handler, mods...)
}
...
func PointerOverEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerOver", handler, mods...)
}
...
func PointerUpEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PointerUp", handler, mods...)
}
...
func PopStateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PopState", handler, mods...)
}
...
func PopuphiddenEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("popuphidden", handler, mods...)
}
...
func PopuphidingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("popuphiding", handler, mods...)
}
...
func PopupshowingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("popupshowing", handler, mods...)
}
...
func PopupshownEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("popupshown", handler, mods...)
}
...
func ProgressEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("progress", handler, mods...)
}
...
func PushEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("push", handler, mods...)
}
...
func PushSubscriptionChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("PushSubscriptionChange", handler, mods...)
}


// RadioStateChangeEvent provides DOM Event representation for the Event "RadioStateChange".
// 
// The state of a radio has been changed either by a user action or by a script
// (useful for accessibility).
// https://developer.mozilla.org/docs/Web/Events/RadioStateChange
func RadioStateChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("RadioStateChange", handler, mods...)
}
...
func RateChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("RateChange", handler, mods...)
}
...
func ReadyStateChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ReadyStateChange", handler, mods...)
}
...
func ReceivedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("received", handler, mods...)
}
...
func RepeatEventEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("repeatEvent", handler, mods...)
}
...
func ResetEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("reset", handler, mods...)
}
...
func ResizeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("resize", handler, mods...)
}
...
func ResourceTimingBufferFullEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ResourceTimingBufferFull", handler, mods...)
}


// ResultEvent provides DOM Event representation for the Event "result".
// 
// The speech recognition service returns a result — a word or phrase has
// been positively recognized and this has been communicated back to the app.
// https://developer.mozilla.org/docs/Web/Events/result
func ResultEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("result", handler, mods...)
}
...
func ResumeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("resume", handler, mods...)
}
...
func ResumingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("resuming", handler, mods...)
}
...
func SSTabClosingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SSTabClosing", handler, mods...)
}
...
func SSTabRestoredEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SSTabRestored", handler, mods...)
}
...
func SSTabRestoringEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SSTabRestoring", handler, mods...)
}
...
func SSWindowClosingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SSWindowClosing", handler, mods...)
}
...
func SSWindowStateBusyEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SSWindowStateBusy", handler, mods...)
}
...
func SSWindowStateReadyEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SSWindowStateReady", handler, mods...)
}
...
func SVGAbortEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SVGAbort", handler, mods...)
}
...
func SVGErrorEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SVGError", handler, mods...)
}
...
func SVGLoadEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SVGLoad", handler, mods...)
}
...
func SVGResizeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SVGResize", handler, mods...)
}
...
func SVGScrollEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SVGScroll", handler, mods...)
}
...
func SVGUnloadEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SVGUnload", handler, mods...)
}
...
func SVGZoomEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SVGZoom", handler, mods...)
}
...
func ScrollEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("scroll", handler, mods...)
}
...
func SeekedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("seeked", handler, mods...)
}
...
func SeekingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("seeking", handler, mods...)
}
...
func SelectEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("select", handler, mods...)
}
...
func SelectStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SelectStart", handler, mods...)
}
...
func SelectionChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SelectionChange", handler, mods...)
}
...
func SentEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("sent", handler, mods...)
}
...
func ShowEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("show", handler, mods...)
}
...
func SizemodechangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("sizemodechange", handler, mods...)
}
...
func SlotChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SlotChange", handler, mods...)
}
...
func SmartcardInsertEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("smartcard-insert", handler, mods...)
}
...
func SmartcardRemoveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("smartcard-remove", handler, mods...)
}
...
func SoundEndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SoundEnd", handler, mods...)
}
...
func SoundStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SoundStart", handler, mods...)
}


// SpeechEndEvent provides DOM Event representation for the Event "SpeechEnd".
// 
// Speech recognised by the speech recognition service has stopped being
// detected.
// https://developer.mozilla.org/docs/Web/Events/speechend
func SpeechEndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SpeechEnd", handler, mods...)
}


// SpeechStartEvent provides DOM Event representation for the Event "SpeechStart".
// 
// Sound that is recognised by the speech recognition service as speech has
// been detected.
// https://developer.mozilla.org/docs/Web/Events/speechstart
func SpeechStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("SpeechStart", handler, mods...)
}
...
func StalledEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("stalled", handler, mods...)
}
...
func StartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("start", handler, mods...)
}
...
func StatechangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("statechange", handler, mods...)
}
...
func StatuschangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("statuschange", handler, mods...)
}
...
func StkcommandEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("stkcommand", handler, mods...)
}
...
func StksessionendEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("stksessionend", handler, mods...)
}
...
func StorageEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("storage", handler, mods...)
}
...
func SubmitEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("submit", handler, mods...)
}
...
func SuccessEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("success", handler, mods...)
}
...
func SuspendEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("suspend", handler, mods...)
}
...
func TabCloseEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TabClose", handler, mods...)
}
...
func TabHideEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TabHide", handler, mods...)
}
...
func TabOpenEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TabOpen", handler, mods...)
}
...
func TabPinnedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TabPinned", handler, mods...)
}
...
func TabSelectEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TabSelect", handler, mods...)
}
...
func TabShowEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TabShow", handler, mods...)
}
...
func TabUnpinnedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TabUnpinned", handler, mods...)
}
...
func TimeUpdateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TimeUpdate", handler, mods...)
}
...
func TimeoutEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("timeout", handler, mods...)
}


// TouchCancelEvent provides DOM Event representation for the Event "TouchCancel".
// 
// A touch point has been disrupted in an implementation-specific manners (too
// many touch points for example).
// https://developer.mozilla.org/docs/Web/Events/touchcancel
func TouchCancelEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TouchCancel", handler, mods...)
}
...
func TouchEndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TouchEnd", handler, mods...)
}
...
func TouchEnterEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TouchEnter", handler, mods...)
}
...
func TouchLeaveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TouchLeave", handler, mods...)
}
...
func TouchMoveEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TouchMove", handler, mods...)
}
...
func TouchStartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TouchStart", handler, mods...)
}
...
func TransitionEndEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("TransitionEnd", handler, mods...)
}
...
func TransitioncancelEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("transitioncancel", handler, mods...)
}
...
func TransitionrunEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("transitionrun", handler, mods...)
}
...
func TransitionstartEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("transitionstart", handler, mods...)
}


// UnderflowEvent provides DOM Event representation for the Event "underflow".
// 
// An element is no longer overflowed by its content (only works for elements
// styled with overflow != visible).
// https://developer.mozilla.org/docs/Web/Events/underflow
func UnderflowEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("underflow", handler, mods...)
}
...
func UnloadEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("unload", handler, mods...)
}
...
func UpdateReadyEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("UpdateReady", handler, mods...)
}


// UpgradeNeededEvent provides DOM Event representation for the Event "UpgradeNeeded".
// 
// An attempt was made to open a database with a version number higher than its
// current version. A versionchange transaction has been created.
// https://developer.mozilla.org/docs/Web/Reference/Events/upgradeneeded_indexedDB
func UpgradeNeededEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("UpgradeNeeded", handler, mods...)
}


// UserProximityEvent provides DOM Event representation for the Event "UserProximity".
// 
// Fresh data is available from a proximity sensor (indicates whether the
// nearby object is near the device or not).
// https://developer.mozilla.org/docs/Web/Events/userproximity
func UserProximityEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("UserProximity", handler, mods...)
}
...
func UssdreceivedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ussdreceived", handler, mods...)
}
...
func VRDisplayPresentChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("VRDisplayPresentChange", handler, mods...)
}


// ValueChangeEvent provides DOM Event representation for the Event "ValueChange".
// 
// The value of an element has changed (a progress bar for example, useful for
// accessibility).
// https://developer.mozilla.org/docs/Web/Events/ValueChange
func ValueChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("ValueChange", handler, mods...)
}
...
func VersionChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("VersionChange", handler, mods...)
}
...
func VisibilityChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("VisibilityChange", handler, mods...)
}
...
func VoicechangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("voicechange", handler, mods...)
}


// VoicesChangedEvent provides DOM Event representation for the Event "VoicesChanged".
// 
// The list of SpeechSynthesisVoice objects that would be returned by the
// SpeechSynthesis.getVoices() method has changed (when the voiceschanged event
// fires.)
// https://developer.mozilla.org/docs/Web/Events/voiceschanged
func VoicesChangedEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("VoicesChanged", handler, mods...)
}
...
func VolumeChangeEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("VolumeChange", handler, mods...)
}
...
func VrdisplayactivateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("vrdisplayactivate", handler, mods...)
}
...
func VrdisplayblurEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("vrdisplayblur", handler, mods...)
}
...
func VrdisplayconnectEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("vrdisplayconnect", handler, mods...)
}
...
func VrdisplaydeactivateEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("vrdisplaydeactivate", handler, mods...)
}
...
func VrdisplaydisconnectEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("vrdisplaydisconnect", handler, mods...)
}
...
func VrdisplayfocusEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("vrdisplayfocus", handler, mods...)
}
...
func WaitingEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("waiting", handler, mods...)
}
...
func WheelEvent(handler interface{}, mods ...EventModder) *EventDescriptor {
	return NewEventDescriptor("wheel", handler, mods...)
}
